...
namespace Raicu_Eva_Lab4
{
    ...
    {
        public const string RetrainFilePath =  @"C:\Users\Eva\Downloads\fare-train-data.csv";
        ...
        public static IEstimator<ITransformer> BuildPipeline(MLContext mlContext)
        {
            ...
            var pipeline = mlContext.Transforms.Categorical.OneHotEncoding(new []{new InputOutputColumnPair(@"vendor_id", @"vendor_id"),new InputOutputColumnPair(@"payment_type", @"payment_type")}, outputKind: OneHotEncodingEstimator.OutputKind.Indicator)      
                                    ...
                                    .Append(mlContext.Regression.Trainers.LightGbm(new LightGbmRegressionTrainer.Options(){NumberOfLeaves=556,NumberOfIterations=653,MinimumExampleCountPerLeaf=22,LearningRate=0.6526668492224412,LabelColumnName=@"fare_amount",FeatureColumnName=@"Features",Booster=new GradientBooster.Options(){SubsampleFraction=0.9999997766729865,FeatureFraction=0.969615744216175,L1Regularization=2E-10,L2Regularization=0.29880617478913707},MaximumBinCountPerFeature=206}));
